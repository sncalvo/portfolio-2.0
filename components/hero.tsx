      ...
      <div className="max-w-[700px]">
        <div className="pt-8 pb-10">
          ...
          <h1 className="h1 font-aspekta mb-5">
            Hi, I'm Santi. <span className="sr-only">Santiago Calvo</span> I build teams and ship{' '}
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400">
            Engineering Manager @ <a href="https://www.eagerworks.com" target="_blank" className="underline hover:text-sky-500 transition-color">Eagerworks</a> based in the UK. I specialize in leading high-performing teams and building scalable applications with Ruby on Rails and Next.js.
          </p>
